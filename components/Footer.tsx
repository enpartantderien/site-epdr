      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 text-center">
        <div className="mb-16">
          <div className="text-3xl font-black tracking-tighter mb-6 text-violet-500 uppercase">
            EN PARTANT DE RIEN <span className="font-light text-white/40">CM</span>
          </div>
        ...
        <div className="flex justify-center mb-16">
          <a 
            ...
            className="text-xs font-black tracking-[0.3em] text-white/40 hover:text-violet-400 transition-colors uppercase"
          >
            Instagram
          </a>
        </div>
