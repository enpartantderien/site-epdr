          ...
          {isMobile && (
            <>
              <button 
                ...
                className="absolute left-0 top-1/2 -translate-y-1/2 z-20 w-10 h-10 flex items-center justify-center bg-black border border-white/10 rounded-full text-white/50 active:scale-95 active:text-violet-500 active:border-violet-500/50 transition-all"
              ...
              <button 
                ...
                className="absolute right-0 top-1/2 -translate-y-1/2 z-20 w-10 h-10 flex items-center justify-center bg-black border border-white/10 rounded-full text-white/50 active:scale-95 active:text-violet-500 active:border-violet-500/50 transition-all"
          ...
          <div className="overflow-hidden md:overflow-visible mx-2 md:mx-0">
            ...
            >
              {services.map((service, idx) => (
                <div 
                  key={idx}
                  className="w-full shrink-0 md:w-auto md:shrink bg-black backdrop-blur-md p-12 hover:bg-zinc-950 transition-all group cursor-default min-h-[400px] flex flex-col justify-center border border-white/5"
                >
