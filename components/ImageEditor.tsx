...
const ImageEditor: React.FC = () => {
  ...
  return (
    <section id="ai-lab" className="py-32 bg-black">
        ...
        <div className="bg-black p-8 lg:p-16 border border-white/5 rounded-sm">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div className="space-y-12">
              <div>
                ...
                <div 
                  ...
                  className="w-full h-64 border border-white/10 bg-black flex flex-col items-center justify-center cursor-pointer hover:border-white transition-all overflow-hidden relative"
                >
                  {image ? (
            ...
            <div className="h-full flex flex-col">
              ...
              <div className="flex-1 min-h-[450px] border border-white/10 bg-black flex items-center justify-center overflow-hidden relative">
                {result ? (
