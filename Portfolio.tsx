...
export const projectsData: CaseStudy[] = [
  {
    ...
    image: 'https://i.postimg.cc/yx08CfSX/bee0c4cc-353f-4a5f-969a-eddea0dd9e64.jpg',
  ...
  },
  {
    ...
    image: 'https://i.postimg.cc/Bn7skWVJ/95d3d14d-89a4-4e88-a88a-f84e8d56201b.jpg',
  ...
  },
  {
    ...
    stats: [{ label: 'Format', value: '4K Pro' }, { label: 'Impact', value: 'Maximal' }],
    description: "Vous organisez un évent ? Vous voulez marquer le coup ? On vient, on filme, on monte. Une vidéo de haute qualité pour immortaliser chaque instant.",
    challenge: "Capturer l'énergie, l'émotion et les moments forts d'un événement pour créer un contenu promotionnel hautement percutant.",
    solution: "Déploiement d'un cadreur pro, captation dynamique sur le terrain et réalisation soignée, suivis d'un montage rythmé avec effets sonores, musique et sous-titres.",
    results: [],
    deliverables: [
      "1 vidéo promotionnelle (jusqu'à 1min30)",
      "Montage sophistiqué & effets sonores",
