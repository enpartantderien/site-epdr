...
const offers = [
  {
    ...
    supplements: 'Drone, éclairage pro, stabilisateur, deuxième caméra, montage complexe...',
    features: [
  ...
  },
  {
    ...
    price: 'À partir de 1150€/mois',
    description: 'Le pilotage complet de votre présence digitale. Nous ne postons pas, nous bâtissons votre autorité.',
    supplements: "Drone, éclairage pro, deuxième caméra, montage complexe, publier sur d'autres plateformes, nombre de réel/post...",
    features: [
  ...
  },
  {
    id: 'promo',
    title: 'LA PROMO',
    subtitle: 'PRESTATION VIDÉO PROMOTIONNELLE',
    ...
    features: [
      '1 vidéo',
      'Montage sophistiqué, effets sonores, musique, sous-titre',
      'Session de tournage (2h)*',
      'Deux modifications',
      "Durée jusqu'à 1min30"
    ],
    cta: 'LANCER MA VIDÉO',
    popular: false
  }
